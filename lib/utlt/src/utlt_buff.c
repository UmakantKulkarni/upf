...
#define MAX_NUM_OF_BUFBLK_POOL       256*256

#define MAX_NUM_OF_BUFBLK_POOL_64    128*256
#define MAX_NUM_OF_BUFBLK_POOL_128   128*256
#define MAX_NUM_OF_BUFBLK_POOL_256   128*256
#define MAX_NUM_OF_BUFBLK_POOL_512   64*256
#define MAX_NUM_OF_BUFBLK_POOL_1024  64*256
